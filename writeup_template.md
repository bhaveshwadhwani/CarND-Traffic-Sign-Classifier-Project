...
You're reading it! and here is a link to my [project code](https://github.com/bhaveshwadhwani/CarND-Traffic-Sign-Classifier-Project/blob/master/Traffic_sign_classfier.ipynb)
...
* The size of training set is 46480
